...
<body>
	...
	<div class="w3-content w3-container w3-margin-top">
		<div class="w3-container w3-card-4">
			...
			<div>
				<form id="joinForm" action="./managerjoin" method="post">
					<p>
						<label>아이디</label> <input name="M_id" id="M_id" class="w3-input"
					...
					<p>
						<label>연락처</label> <input name="M_phone" id="M_phone"
							class="w3-input" required>
					</p>
					<p>
